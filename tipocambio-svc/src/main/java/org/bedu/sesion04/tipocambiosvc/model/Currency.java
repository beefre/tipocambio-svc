...
public class Currency {
    ...
    static{
        exchanges.put("MXN", Arrays.asList(new Combination("USD",.056),new Combination("EUR",.052)));
        exchanges.put("USD", Arrays.asList(new Combination("MXP", 17.85), new Combination("EUR", .93)));
